...
public class OperatorConditional {
    public static void main(String[] args) {
        ...
        System.out.println("Conditial AND");
        boolean result = value == 3 && anotherValue == 5;
        boolean anotherResult = value != 3 && anotherValue == 5;

        System.out.println("Hasil Operator AND pada syarat value == 3 && anotherValue == 5 adalah " + value);
        System.out.println("Hasil Operator AND pada syarat value != 3 && anotherValue == 5 adalah " + anotherValue);
        System.out.println();
